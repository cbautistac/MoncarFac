    ...
    public string GenFactura(int idCfd,object[] encabezado, DataTable detalle, object[] timbre)
    {
        ...
        if (archivo.Trim() != "")
        {
            ...
            */
            ...
            tablaDetalle.SetWidths(new float[] { 10f, 10f, 10f, 24f, 10f, 10f, 13f, 13f });
            ...
            tituPagina = new PdfPCell(new Phrase("Clave Prod/Serv SAT", FontFactory.GetFont("ARIAL", 7, iTextSharp.text.Font.BOLD, BaseColor.BLACK)));
            tituPagina.HorizontalAlignment = 1;
            tituPagina.VerticalAlignment = 1;
            ...
            tituPagina = new PdfPCell(new Phrase("Unidad Medida SAT", FontFactory.GetFont("ARIAL", 7, iTextSharp.text.Font.BOLD, BaseColor.BLACK)));
            tituPagina.HorizontalAlignment = 1;
            tituPagina.VerticalAlignment = 1;
            tituPagina.PaddingTop = 2f;
            tituPagina.BackgroundColor = grisClaro;
            ...
            foreach (DataRow fila in detalle.Rows) {
                ...
                //impresion de codigo SAT
                tituPagina = new PdfPCell(new Phrase(fila[18].ToString(), FontFactory.GetFont("ARIAL", 7, iTextSharp.text.Font.NORMAL, BaseColor.BLACK)));
                tituPagina.HorizontalAlignment = 1;
                tituPagina.VerticalAlignment = 1;
                tituPagina.Border = 0;
                tablaDetalle.AddCell(tituPagina);
                ...
                //impresion de medidaSAT
                tituPagina = new PdfPCell(new Phrase(fila[19].ToString(), FontFactory.GetFont("ARIAL", 7, iTextSharp.text.Font.NORMAL, BaseColor.BLACK)));
                tituPagina.HorizontalAlignment = 1;
                tituPagina.VerticalAlignment = 1;
                tituPagina.Border = 0;
                tablaDetalle.AddCell(tituPagina);
