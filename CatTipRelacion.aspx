<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="CatTipRelacion.aspx.cs" Inherits="CatTipRelacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <asp:Label ID="lblTitulo" runat="server" Text=""></asp:Label>
                       ...
                       <div class="col-lg-12 col-sm-12 text-center">
                        ...
                        <!--para seleccionar el banco -->
                          <div class="col-lg-2 col-sm-2 text-center"><asp:Label ID="lblClvTR" runat="server" Text="Clave Tipo Relación:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-2 col-sm-2 text-left">
                            <asp:TextBox ID="txtClaveTipR" runat="server" MaxLength="13" CssClass="input-left" />
                            <cc1:TextBoxWatermarkExtender ID="txtClaveTipRWatermarkExtender1" runat="server" BehaviorID="txtClaveTipR_TextBoxWatermarkExtender" TargetControlID="txtClaveTipR" WatermarkCssClass="input-medium water" WatermarkText="Clave Tipo Relación" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Debe indicar la Clave del Tipo Relación" CssClass="errores alineado" ValidationGroup="agrega" ControlToValidate="txtClaveTipR" Text="*"></asp:RequiredFieldValidator>
                        </div>  
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label2" runat="server" Text="Tipo Relación"></asp:Label>
            </h3>
        </div>
    </div>
   ...
   <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" EnableAJAX="true">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select ClaveTipo, Descripcion from TipoRelacion_FSAT
