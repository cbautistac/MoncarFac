<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Remisiones.aspx.cs" Inherits="Remisiones" MasterPageFile="~/AdmonOrden.master" UICulture="es-Mx" Culture="es-Mx" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center alert-info">
                    <h3>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Remisión"></asp:Label>
                    </h3>
                </div>
            </div>
                ...
                <div class="row">
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid3" GridLines="None" runat="server" PageSize="50" CssClass="col-lg-12 col-sm-12" AllowAutomaticUpdates="false" AllowPaging="True" AutoGenerateColumns="False" PagerStyle-AlwaysVisible="true" 
                        ...
                        <MasterTableView CommandItemDisplay="None" DataKeyNames="id_remision_ss" HorizontalAlign="NotSet" AutoGenerateColumns="False" DataSourceID="SqlDataSource3">                                                                
                            <Columns>
                                <telerik:GridBoundColumn DataField="no_remision_ss" HeaderText="Remision" HeaderStyle-Width="80px" SortExpression="no_remision_ss" UniqueName="no_remision_ss" ReadOnly="true"/>
                            ...
                            <NoRecordsTemplate>
                                <asp:Label ID="lblnoReecMo" runat="server" Text="No existen remisiones previas" CssClass="errores"></asp:Label>
                            </NoRecordsTemplate>
                        </MasterTableView>                                
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" GridLines="None" runat="server" PageSize="50" CssClass="col-lg-12 col-sm-12" AllowAutomaticUpdates="True" AllowPaging="True" AutoGenerateColumns="False" PagerStyle-AlwaysVisible="true" 
                                ...
                                <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="consecutivo" HorizontalAlign="NotSet" EditMode="Batch" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">                                    
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridNumericColumn DataField="monto_mo" HeaderText="Monto" HeaderStyle-Width="100px" SortExpression="monto_mo" UniqueName="monto_mo" DataFormatString="{0:C2}" DecimalDigits="2" />                                                                               
                                        <telerik:GridCheckBoxColumn DataField="aplica_rem" HeaderStyle-Width="80px" HeaderText="Aplicar" SortExpression="aplica_rem" UniqueName="aplica_rem"/>                                        
                                    </Columns>
                                    <NoRecordsTemplate>
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" GridLines="None" runat="server" PageSize="50" AllowAutomaticUpdates="True" CssClass="col-lg-12 col-sm-12" AllowPaging="True" AutoGenerateColumns="False" PagerStyle-AlwaysVisible="true" 
                                ...
                                <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="refOrd_Id" HorizontalAlign="NotSet" EditMode="Batch" AutoGenerateColumns="False" DataSourceID="SqlDataSource2">                                    
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridNumericColumn DataField="refPrecioVenta" HeaderText="Venta Unitaria" HeaderStyle-Width="80px" SortExpression="refPrecioVenta" UniqueName="refPrecioVenta" DataFormatString="{0:C2}" DecimalDigits="2" />                                        
            ...
            <div class="row pad1m">
                ...
                <div class="col-lg-6 col-sm- text-center">
                    <asp:LinkButton ID="lnkGeneraRemision" runat="server" CssClass="btn btn-primary" OnClick="lnkGeneraRemision_Click"><i class="fa fa-bookmark"></i><span>&nbsp; Generar Remisi&oacute;n</span></asp:LinkButton>
                </div>
                <div class="col-lg-6 col-sm- text-center">
                    <asp:LinkButton ID="lnkImprime" runat="server" CssClass="btn btn-primary" OnClick="lnkImprime_Click"><i class="fa fa-print"></i><span>&nbsp; Imprimir Remisi&oacute;n</span></asp:LinkButton>
                </div>
                    <%--<div class="col-lg-4 col-sm-4">
                        <div class="row text-center" ><asp:Label ID="Label5" runat="server" Text="Total Mano Obra: " CssClass="textoBold text-info t18"></asp:Label><asp:Label ID="lblTotMo" runat="server" CssClass="textoBold t18"><asp:Label ID="lblMontoMo" runat="server" CssClass="textoBold t18" Visible="false"></asp:Label></asp:Label></div>
                    </div>
                    <div class="col-lg-4 col-sm-4">
                        <div class="row text-center"><asp:Label ID="Label7" runat="server" Text="Total Refacciones: " CssClass="textoBold text-info t18"></asp:Label><asp:Label ID="lblTotRef" runat="server" CssClass="textoBold t18"></asp:Label><asp:Label ID="lblMontoRef" runat="server" CssClass="textoBold t18" Visible="false"></asp:Label></div>
                    </div>
                <div class="col-lg-4 col-sm-4">
                        <div class="row text-center"><asp:Label ID="Label9" runat="server" Text="Total Remision: " CssClass="textoBold text-info t18"></asp:Label><asp:Label ID="lblTotalRemision" runat="server" CssClass="textoBold t18"></asp:Label></div>
                    </div>--%>
            </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PVW %>"                                
        SelectCommand="select mo.consecutivo, (gop.descripcion_go+' '+o.descripcion_op+' '+mo.id_refaccion) as manoObra,mo.monto_mo,mo.aplica_rem,mo.id_remision from mano_obra mo inner join Grupo_Operacion gop on gop.id_grupo_op=mo.id_grupo_op inner join Operaciones o on o.id_operacion=mo.id_operacion where mo.no_orden=@orden and mo.id_empresa=@empresa and mo.id_taller=@taller and mo.id_remision=0"
        UpdateCommand="UPDATE mano_obra SET aplica_rem = @aplica_rem, monto_mo=@monto_mo WHERE no_orden=@orden and id_empresa=@empresa and id_taller=@taller and consecutivo=@consecutivo">
        <SelectParameters>
        ...
        <UpdateParameters>
            <asp:Parameter Name="aplica_rem" Type="Boolean"></asp:Parameter>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PVW %>"                                
        SelectCommand="select refOrd_Id,refCantidad,refDescripcion,refCosto,refporcentsobrecosto,refPrecioVenta,(refcantidad*refprecioventa) as importe, aplica_rem from Refacciones_Orden where ref_no_orden=@orden and ref_id_empresa=@empresa and ref_id_taller=@taller and refestatus<>'CA' and id_remision=0 and refestatusSolicitud<>11"
        UpdateCommand="UPDATE Refacciones_Orden SET aplica_rem = @aplica_rem, refPrecioVenta=@refPrecioVenta WHERE ref_no_orden=@orden and ref_id_empresa=@empresa and ref_id_taller=@taller and refOrd_Id=@refOrd_Id">
        <SelectParameters>
            <asp:QueryStringParameter Name="orden" QueryStringField="o" DbType="Int32" DefaultValue="0" />
            <asp:QueryStringParameter Name="empresa" QueryStringField="e" DbType="Int32" DefaultValue="0" />
            <asp:QueryStringParameter Name="taller" QueryStringField="t" DbType="Int32" DefaultValue="0" />
...
where R.id_empresa=@empresa and R.id_taller=@taller and R.no_orden=@orden and R.tipo='R'
