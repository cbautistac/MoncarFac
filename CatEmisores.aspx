<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="CatEmisores.aspx.cs" Inherits="CatEmisores" %>
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label1" runat="server" Text="Catalogo Emisores"></asp:Label>
            </h3>
        </div>
    </div>
        ...
        <ContentTemplate>            
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                ...
                <div class="col-lg-12 col-sm-12 marTop text-center">
                    ...
                    <div class="col-lg-3 col-sm-3 text-center">
                        <asp:LinkButton ID="btnBorrar" runat="server" CssClass="btn btn-danger t14" Visible="false" OnClick="btnBorrar_Click" ToolTip="Borrar" ><i class="fa fa-times"></i>&nbsp;<span>Borrar</span></asp:LinkButton>
                    </div>
                    <div class="col-lg-3 col-sm-3 text-center">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" EnableAJAX="true">
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true"  runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="idEmisor">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="EmRFC" FilterControlAltText="Filtro Nombre" HeaderText="Nombre" SortExpression="nombre_completo" UniqueName="nombre_completo" Resizable="true"  />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="EmNombre" FilterControlAltText="Filtro RFC" HeaderText="RFC" SortExpression="rfc_cli" UniqueName="rfc_cli" Resizable="true" />
                            </Columns>
                        </MasterTableView>
                        <ClientSettings AllowKeyboardNavigation="true" EnablePostBackOnRowClick="true">
                            ...
                            <Selecting AllowRowSelect="true" />
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                    ...
                                                    SelectCommand="Select * from emisores_f">
                                                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
                ...
                <ContentTemplate>
                    <asp:Panel ID="pnlPrincipal" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:PVW %>" SelectCommand="select ID_Colonia,Desc_Colonia from Colonias_f where cve_pais=@pais and ID_Estado=@estado and ID_Del_Mun=@municipio">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlPaisEx" Name="pais" />
                                    <asp:ControlParameter ControlID="ddlEstadoEx" Name="estado" />
                        ...
                        <div class="col-lg-9 col-sm-9 text-left">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:PVW %>" SelectCommand="select ID_Cod_Pos from Colonias_f where cve_pais=@pais and ID_Estado=@estado and ID_Del_Mun=@municipio and ID_Colonia=@colonia">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlPaisEx" Name="pais" />
                                    <asp:ControlParameter ControlID="ddlEstadoEx" Name="estado" />
                                    <asp:ControlParameter ControlID="ddlMunicipioEx" Name="municipio" />
