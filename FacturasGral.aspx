            ...
            <ContentTemplate>
                ...
                <asp:Panel runat="server" ID="pnlDaños" CssClass="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PVW %>"
                            SelectCommand="
select distinct e.idCfd,e.EncFolioUUID,e.EncReferencia,convert(char(10),e.EncFechaGenera,120)+' '+convert(char(8),e.enchoragenera,120) as EncFechaGenera,e.EncReRFC,case when e.EncReNombre is null then (select renombre from receptores_f where idrecep=e.idrecep) when e.encrenombre='' then (select renombre from receptores_f where idrecep=e.idrecep) else e.encrenombre end as EncReNombre,e.EncEstatus, 
...
from EncCFD_f e left join receptores_f r on r.idrecep=e.idrecep where e.encestatus=@estatus order by e.idcfd desc">
                            <SelectParameters>
    ...
    <br /><br />
     <div class="col-lg-6 col-sm-6 text-center">
                    ...
                    <asp:TextBox ID="txtFechaIni" runat="server" CssClass="alingMiddle input-small"  ></asp:TextBox>
     ...
     <div class="col-lg-6 col-sm-6 text-center">
                    ...
                    <asp:TextBox ID="txtFechaFin" runat="server" CssClass="alingMiddle input-small" ></asp:TextBox>
    ...
    <div class="col-lg-12 col-sm-12 text-center">
         <asp:Label ID="lblIni" runat="server" Visible="false" />
         <asp:Label ID="lblFin" runat="server" Visible="false" />
                    <asp:Button ID="Button1" runat="server" Text="Descargar Facturas" Visible="true" CssClass="btn-info" OnClick="impCatProd_Click" />
            </div> 
