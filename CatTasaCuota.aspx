<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="CatTasaCuota.aspx.cs" Inherits="CatTasaCuota" %>
                ...
                <asp:Label ID="lblTitulo" runat="server" Text=""></asp:Label>
                       ...
                       <div class="col-lg-12 col-sm-12 text-center">
                        ...
                        <div class="col-lg-6 col-sm-6 text-center ">
                            <asp:LinkButton ID="lnkAgregarNuevo" runat="server" CssClass="btn btn-success t14" ValidationGroup="agrega"><i class="fa fa-check-circle"></i>&nbsp; Agregar</asp:LinkButton>
                        </div>
                        <div class="col-lg-6 col-sm-6 text-center ">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label2" runat="server" Text="Tasa Cuota"></asp:Label>
            </h3>
        </div>
    </div>
